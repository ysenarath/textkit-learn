...
canonical = {
    "western": {
        ...
        "upright_latin_only_emoticons_and_single_line_art_and_portraits": {
            ...
            "surprise_shock_yawn": ["O_O", "o_o", "O-O", "o‑o", "O_o", "o_O"],
    ...
    "two_channel": {
        ...
        "_2channel_emoticons_containing_japanese_phrases": {
            "its_here_kitaa_excitement": ["キタ━━━(゜∀゜)━━━!!!!!"],
            "girlish_its_here_kitaa_excitementversion": [
                "ｷﾀﾜァ*･゜ﾟ･*:.｡..｡.:*･゜(n‘∀‘)ηﾟ･*:.｡. .｡.:*･゜ﾟ･* !!"
            ],
            "erotic_stirring_haa_haa": ["(*´Д`)ﾊｧﾊｧ"],
            "patting_nade_nade": ["(　´Д｀)ﾉ(´･ω･`)　ﾅﾃﾞﾅﾃﾞ"],
            "calling_out_ooooi": ["(*ﾟﾉOﾟ)<ｵｵｵｵｫｫｫｫｫｫｫｰｰｰｰｰｲ!"],
            "evil_laugh": ["( ﾟ∀ﾟ)ｱﾊﾊ八八ﾉヽﾉヽﾉヽﾉ ＼ / ＼/ ＼"],
            "blaming_now_now": ["（・∀・ ）ヾ(- -；)コラコラ"],
            "kana_reading_o_ya_su_mi": ["お(^o^)や(^O^)す(^｡^)みぃ(^-^)ﾉﾞ"],
        },
    },
}
# https://github.com/carvilsi/facetxt
customs = {
    "custom": {
        "facetxt": {
            "cthulhu": ["^(;,;)^"],
